...
class OperatorTest {
    ...
    fun `Equal over different types`() {
        val result = Equal.operation(Env.EMPTY, VWhole(3), VStr("Hello"))
    ...
    fun `Equal over same type but different value`() {
        val result = Equal.operation(Env.EMPTY, VWhole(2), VWhole(3))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `Equal over same values`() {
        val result = Equal.operation(Env.EMPTY, VWhole(2), VWhole(2))
        assertIs<VBool>(result)
    ...
    fun `Larger when the first argument is larger`() {
        val result = Larger.operation(Env.EMPTY, VWhole(3), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
    ...
    fun `Larger when the first argument is smaller`() {
        val result = Larger.operation(Env.EMPTY, VWhole(2), VWhole(3))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `Larger when the arguments are equal`() {
        val result = Larger.operation(Env.EMPTY, VWhole(2), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `LargerEq when the first argument is larger`() {
        val result = LargerEq.operation(Env.EMPTY, VWhole(3), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
    ...
    fun `LargerEq when the first argument is smaller`() {
        val result = LargerEq.operation(Env.EMPTY, VWhole(2), VWhole(3))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `LargerEq when the arguments are equal`() {
        val result = LargerEq.operation(Env.EMPTY, VWhole(2), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
    ...
    fun `Smaller when the first argument is larger`() {
        val result = Smaller.operation(Env.EMPTY, VWhole(3), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `Smaller when the first argument is smaller`() {
        val result = Smaller.operation(Env.EMPTY, VWhole(2), VWhole(3))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
    ...
    fun `Smaller when the arguments are equal`() {
        val result = Smaller.operation(Env.EMPTY, VWhole(2), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `SmallerEq when the first argument is larger`() {
        val result = SmallerEq.operation(Env.EMPTY, VWhole(3), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(false, result.value)
    }
    ...
    fun `SmallerEq when the first argument is smaller`() {
        val result = SmallerEq.operation(Env.EMPTY, VWhole(2), VWhole(3))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
    ...
    fun `SmallerEq when the arguments are equal`() {
        val result = SmallerEq.operation(Env.EMPTY, VWhole(2), VWhole(2))
        assertIs<VBool>(result)
        assertEquals(true, result.value)
    }
